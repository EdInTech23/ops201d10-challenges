...
Get-WinEvent -LogName System -MaxEvents ([System.Int32]::MaxValue) | Where-Object {$_.TimeCreated -gt (Get-Date).AddHours(-24)} | Out-File -FilePath "$env:C:\Users\prete\Desktop\last_24.txt"


# Output all “error” type events from the System event log to a file on your desktop named errors.txt.
Get-WinEvent -LogName System -MaxEvents ([System.Int32]::MaxValue) | Where-Object {$_.LevelDisplayName -eq "Error"} | Out-File -FilePath "$env:C:\Users\prete\Desktop\errors.txt"
